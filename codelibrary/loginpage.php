...
<body class="bodyofloginpage">
  ...
  <div class="signupandloginform">
   <form method="POST">
    ...
    border:2px solid black; ">
    <br><br>
    <input type="text" name="email" placeholder=" email" size="20" style=" font-size:25;height:30px;
    border:2px solid black; ">
    <br><br>
    ...
    border:2px solid black; border-radius:15px;">signup</button><br>
   </form>
 ...
 <!-- loginform -->
  <form method="POST">
    ...
    <button type="text" name="loginsubmit"size="20" style=" font-size:25;height:35px;
     border:2px solid black; border-radius:15px;">login</button>
  </form>
</div>
  <?php
    ...
    if(isset($_POST['signupsubmit']))
    {
      ...
      if(empty($name) || empty($password))
      {
        ...
        // echo "hey man";
        $sql="INSERT into usertable(username,userpassword,useremail) values('$name','$password','$email'); ";
      ...
      if(!empty($name) && !empty($password))
      {
        ...
        $result = mysqli_query($conn,$sql);
         ...
         if($no_of_results>0)
         {
           ...
           header("Location: mainpageversion2.php");
